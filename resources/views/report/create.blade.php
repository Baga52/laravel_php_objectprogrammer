        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-700">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('reports.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <textarea
                                ...
                                rows="5"
                                required
                                class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"></textarea>
                        </div>

                        <div class="mb-4">
                            <x-input-label for="path_img" :value="__('Фото нарушения')" />
                            <input
                                type="file"
                                id="path_img"
                                name="path_img"
